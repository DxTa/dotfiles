...
** TODO Spelling
   ...
   | Platform  | Command                  |
   |-----------+--------------------------|
   | Mac OS X  | =brew install hunspell=    |
   | Archlinux | =sudo pacman - S hunspell= |
   ...
   #+begin_src emacs-lisp :tangle no
     (use-package emms
       ...
       (progn
         ...
         (require 'emms-player-mpv-quiet)
         (setq emms-player-mpv-quiet-command "/Users/tung/Applications/Mpv.app/Contents/MacOS/mpv")
