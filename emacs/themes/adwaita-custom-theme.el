;;; adwaita-custom-theme.el --- Tango-based custom theme for faces
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(region ((,class (:foreground unspecified :background "#4A90D9"))))
   `(hl-line ((,class (:foreground unspecified :background "#C2D5E9"))))
...
;;; adwaita-custom-theme.el  ends here
