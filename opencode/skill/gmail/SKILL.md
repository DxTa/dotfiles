...
```bash
# Search Gmail
~/.config/opencode/skill/gmail/scripts/gmail.py search '<query>' [max_results]

# Read specific email by search query
~/.config/opencode/skill/gmail/scripts/gmail.py get '<query>' [index]

# List recent emails from inbox
~/.config/opencode/skill/gmail/scripts/gmail.py list [count]

# Search for meeting invites
~/.config/opencode/skill/gmail/scripts/gmail.py invites [days_forward] [max_results]
```
...
```bash
~/.config/opencode/skill/gmail/scripts/gmail.py search "from:john@example.com"
```

**Search for emails with specific subject:**
```bash
~/.config/opencode/skill/gmail/scripts/gmail.py search "subject:project update"
```

**Search for emails with attachments:**
```bash
~/.config/opencode/skill/gmail/scripts/gmail.py search "has:attachment"
```

**Search with date range:**
```bash
~/.config/opencode/skill/gmail/scripts/gmail.py search "after:2024/12/01 before:2024/12/31"
```

**Read first matching email:**
```bash
~/.config/opencode/skill/gmail/scripts/gmail.py get "important" 0
```

**List 10 most recent emails:**
```bash
~/.config/opencode/skill/gmail/scripts/gmail.py list 10
```

**Search for meeting invites in next 7 days:**
```bash
~/.config/opencode/skill/gmail/scripts/gmail.py invites 7 20
```
...
2. Save token to `~/.config/opencode/skill/gmail/gmail_token.json`

**To re-authenticate**:
```bash
rm ~/.config/opencode/skill/gmail/gmail_token.json
~/.config/opencode/skill/gmail/scripts/gmail.py list
```
...
~/.config/opencode/skill/gmail/scripts/gmail.py search "is:unread from:boss@example.com has:attachment"

# Emails sent this week
~/.config/opencode/skill/gmail/scripts/gmail.py search "in:sent after:2025-01-01"

# Subject or body contains "urgent", not from newsletter
~/.config/opencode/skill/gmail/scripts/gmail.py search "urgent -from:newsletter"
```
...
**Command**:
```bash
~/.config/opencode/skill/gmail/scripts/gmail.py search "urgent is:unread"
```
...
**Command**:
```bash
~/.config/opencode/skill/gmail/scripts/gmail.py get "from:john@example.com" 0
```
...
**Command**:
```bash
~/.config/opencode/skill/gmail/scripts/gmail.py search "project after:2024/12/01 before:2025/01/01"
```
