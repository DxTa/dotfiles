...
function config_dir(path)
  return awful.util.getdir("config") .. "/themes/2013/" .. path
end

theme = {}

theme.wallpaper = "/home/tung/Pictures/current.jpg"

theme.font          = "terminus 8"

theme.bg_normal     = "#090f15"
...
theme.taglist_squares_sel   = config_dir("square.png")
theme.taglist_squares_unsel = config_dir("square.png")
